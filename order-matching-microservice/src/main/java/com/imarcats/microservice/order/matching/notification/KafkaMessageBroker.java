...
public class KafkaMessageBroker {
	...
	private static final String IMARCATS_TRADES_TRANSACTIONS = "imarcats_trade_tx";
...
//	}
	...
	private void sendTradeNotification(TradeSideDto tradeSide_) {
		...
		tradeActionMessageKafkaTemplate.send(IMARCATS_TRADES_TRANSACTIONS, tradeActionMessage);
	}
